...
![Screenshot]({{ site.baseurl }}/assets/images/install-the-ibm-fusion-operator-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/install-the-ibm-fusion-operator-02.png)


![Screenshot]({{ site.baseurl }}/assets/images/install-the-ibm-fusion-operator-03.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/install-the-ibm-fusion-operator-04.png)


![Screenshot]({{ site.baseurl }}/assets/images/install-the-ibm-fusion-operator-05.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/connect-to-fusion-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/connect-to-fusion-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/connect-to-fusion-03.png)

1. Click on the View services (A) button or Services (B) menu item to go directly to the Services page.

![Screenshot]({{ site.baseurl }}/assets/images/connect-to-fusion-04.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/events-01.png)

1. You will then be presented with an event log for IBM Fusion.

![Screenshot]({{ site.baseurl }}/assets/images/events-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/events-03.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/events-04.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/call-home-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/call-home-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/services-page-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/ibm-fusion-help-01.png)
