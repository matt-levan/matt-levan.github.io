...
![Screenshot]({{ site.baseurl }}/assets/images/image36.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image37.png)


![Screenshot]({{ site.baseurl }}/assets/images/image38.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image39.png)


![Screenshot]({{ site.baseurl }}/assets/images/image40.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image41.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image42.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image43.png)

1. Click on the View services (A) button or Services (B) menu item to go directly to the Services page.

![Screenshot]({{ site.baseurl }}/assets/images/image44.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image45.png)

1. You will then be presented with an event log for IBM Fusion.

![Screenshot]({{ site.baseurl }}/assets/images/image46.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image47.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image48.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image49.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image50.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image51.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image52.png)
