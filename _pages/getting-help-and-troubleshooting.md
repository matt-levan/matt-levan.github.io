...
![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-01.png)

1. In the example shown below, there are nodes with insufficient memory.

![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-03.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-04.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-05.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-06.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-07.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-08.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-09.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-10.png)


![Screenshot]({{ site.baseurl }}/assets/images/pmcollector-pod-not-running-11.png)
