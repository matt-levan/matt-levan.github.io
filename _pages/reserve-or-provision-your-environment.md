...
![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-03.png)

1. start the Create a request diaglog:

![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-04.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-05.png)


![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-06.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-07.png)

1. Select the Preferred Geography: itzvmware-spectrum – AMERICAS – us-east-region – wdc04 datacenter (A).

![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-08.png)

1. Scheduling, set your time period

![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-09.png)

1. Customize the configuration

![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-10.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-11.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-12.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-13.png)


![Screenshot]({{ site.baseurl }}/assets/images/reserve-an-environment-in-ibm-technology-zone-14.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/connect-to-the-lab-environment-01.png)


![Screenshot]({{ site.baseurl }}/assets/images/connect-to-the-lab-environment-02.png)


![Screenshot]({{ site.baseurl }}/assets/images/connect-to-the-lab-environment-03.png)

Open The reservation

![Screenshot]({{ site.baseurl }}/assets/images/connect-to-the-lab-environment-04.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/connect-to-the-lab-environment-05.png)

You can open the VM remote Console to see the console to all of the nodes and get log in credentials:

![Screenshot]({{ site.baseurl }}/assets/images/connect-to-the-lab-environment-06.png)
