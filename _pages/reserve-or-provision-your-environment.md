...
![Screenshot]({{ site.baseurl }}/assets/images/image8.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image9.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image10.png)

1. start the Create a request diaglog:

![Screenshot]({{ site.baseurl }}/assets/images/image11.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image12.png)


![Screenshot]({{ site.baseurl }}/assets/images/image13.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image14.png)

1. Select the Preferred Geography: itzvmware-spectrum – AMERICAS – us-east-region – wdc04 datacenter (A).

![Screenshot]({{ site.baseurl }}/assets/images/image15.png)

1. Scheduling, set your time period

![Screenshot]({{ site.baseurl }}/assets/images/image16.png)

1. Customize the configuration

![Screenshot]({{ site.baseurl }}/assets/images/image17.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image18.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image19.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image20.png)


![Screenshot]({{ site.baseurl }}/assets/images/image21.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/image22.png)


![Screenshot]({{ site.baseurl }}/assets/images/image23.png)


![Screenshot]({{ site.baseurl }}/assets/images/image24.png)

Open The reservation

![Screenshot]({{ site.baseurl }}/assets/images/image25.png)
