---
layout: default
title: "Protect Containerized Workload – Backup/Restore"
permalink: /protect-containerized-workload-backuprestore/
nav_order: 11
---
...
![Screenshot]({{ site.baseurl }}/assets/images/install-backup-restore-service-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/install-backup-restore-service-02.png)

1. Click the Install (A) button to begin the installation process for the Backup & Restore service.

![Screenshot]({{ site.baseurl }}/assets/images/install-backup-restore-service-03.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/install-backup-restore-service-04.png)

1. Click on the Install (A) button.

![Screenshot]({{ site.baseurl }}/assets/images/install-backup-restore-service-05.png)

1. The Backup & Restore service installation will show as Installing.

![Screenshot]({{ site.baseurl }}/assets/images/install-backup-restore-service-06.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/install-backup-restore-service-07.png)

1. Notice that a new Backup & restore menu item has been added to the left-hand navigation pane in the IBM Fusion GUI.

![Screenshot]({{ site.baseurl }}/assets/images/install-backup-restore-service-08.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/create-backup-locations-and-policies-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/create-backup-locations-and-policies-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/backup-location-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/backup-location-02.png)

1. Click create ObjectBucketClaim

![Screenshot]({{ site.baseurl }}/assets/images/backup-location-03.png)

1. Once the bucket claim is created, scroll down and reveal values

We will use the “Bucket Name”, “Access Key” and “Secret Key”.

![Screenshot]({{ site.baseurl }}/assets/images/backup-location-04.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/backup-location-05.png)


![Screenshot]({{ site.baseurl }}/assets/images/backup-location-06.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/backup-location-07.png)

1. Enter the S3 endpoint and connection collected in the previous steps

![Screenshot]({{ site.baseurl }}/assets/images/backup-location-08.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/backup-policies-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/backup-policies-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/backup-policies-03.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/backup-policies-04.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/backup-policies-05.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-03.png)

1. Click on the Import YAML (A) button from the drop-down list provided.

![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-04.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-05.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-06.png)

1. The following information will be displayed listing all resources that were created and Creation status.

![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-07.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-08.png)

1. Login to the File Browser application with Username (A): admin and Password (B): admin. Click the Login (C) button.

![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-09.png)

1. No files will be listed in the Filebrowser application.

![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-10.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/create-a-workload-11.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/assign-policy-using-applications-menu-item-01.png)

1. Select the filebrowser application checkbox (A) and click the Assign backup policy (B) button.

![Screenshot]({{ site.baseurl }}/assets/images/assign-policy-using-applications-menu-item-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/assign-policy-using-applications-menu-item-03.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/assign-policy-using-backed-up-applications-menu-item-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/assign-policy-using-backed-up-applications-menu-item-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/assign-policy-using-backed-up-applications-menu-item-03.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/assign-policy-using-backed-up-applications-menu-item-04.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/monitor-backup-status-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/monitor-backup-status-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-01.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-02.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-03.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-04.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-05.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-06.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-07.png)

1. Confirm the restore by clicking on the Restore (A) button in the final dialog box.

![Screenshot]({{ site.baseurl }}/assets/images/application-restore-08.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-09.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-10.png)

1. Watch the application being restored and the new pods created for the restored application.

![Screenshot]({{ site.baseurl }}/assets/images/application-restore-11.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-12.png)
...
![Screenshot]({{ site.baseurl }}/assets/images/application-restore-13.png)
